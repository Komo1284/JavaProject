...
public class AwtFocus extends Frame implements ActionListener {
	...
	public AwtFocus() {
		...
		EventFocusHandler efh = new EventFocusHandler();
		hidden.addFocusListener(efh);
		moved.addFocusListener(efh);
		resized.addFocusListener(efh);
		shown.addFocusListener(efh);
	...
	class EventFocusHandler extends FocusAdapter {
		public void focusGained(FocusEvent e) {
			Button src = (Button)e.getSource();
			output.append(src.getLabel()+" : Foucs Gained!!\n");
		}
		public void focusLost(FocusEvent e) {
			Button src = (Button)e.getSource();
			output.append(src.getLabel()+" : Foucs Lost!!\n");
		}
	}
